...
public class Adapter extends RecyclerView.Adapter<Adapter.Viewholder>{
    ...
    private void saveData() {
        ...
        try {
            ...
            Toast.makeText(context.getApplicationContext(), "Backup updated!", Toast.LENGTH_LONG).show();
        } catch (IOException e) {
            e.printStackTrace();
            Toast.makeText(context.getApplicationContext(), "Failed to update backup!", Toast.LENGTH_SHORT).show();
        }
    }
